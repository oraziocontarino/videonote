...
public class MediaVideoManager {
    ...
    public void openCamera() {
        ...
        try {
            ...
            try {
                ...
                throw new RuntimeException("No camera available for recording. 111");
            }catch (Exception e){
                throw new RuntimeException("No camera available for recording. 222");
            }
            if(cameraList == null || cameraList.length == 0){
                throw new RuntimeException("No camera available for recording. 333");
            }
            ...
            mPreviewSize = chooseOptimalSize(map.getOutputSizes(SurfaceTexture.class),
                    VIDEO_WIDTH, VIDEO_HEIGHT, mVideoSize);
            ...
            configureTransform(VIDEO_WIDTH, VIDEO_HEIGHT);
            ...
            Toast.makeText(getContext(), "Error evt! "+e.getMessage(), Toast.LENGTH_SHORT).show();
        } catch (InterruptedException e) {
    ...
    public void stopRecordingVideo() {
        ...
        Toast.makeText(getContext(), "Change to record!", Toast.LENGTH_SHORT).show();
